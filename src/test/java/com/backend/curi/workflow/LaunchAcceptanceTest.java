...
public class LaunchAcceptanceTest {
    ...
    void slackIntegrate(){
        ...
        slackInfo.setAccessToken("slackAccessToken");
        slackInfo.setUserFirebaseId("8514199@gmail.com");
        slackInfo.setUserSlackId("slackId");
    ...
    void slackMemberIntegrate(){
        ...
        slackMemberInfo.setAccessToken("slackAccessToken");
        slackMemberInfo.setMemberId(employeeId);
        slackMemberInfo.setMemberSlackId("slackId");
 ...
 */
    ...
    private OAuthRequest getOauthRequest(){
        return new OAuthRequest("oauthToken");
    }
